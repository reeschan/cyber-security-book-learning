...
if __name__ == "__main__":
  parser = argparse.ArgumentParser(description="BHP Net Tool", formatter_class=argparse.RawTextHelpFormatter, epilog=textwrap.dedent(
    '''Execution Examples:
      # invoke iteraction shell
      netcat.py -t 192.168,1,108 -p 5555 -l -c
      # file upload
      netcat.py -t 192.168,1,108 -p 5555 -f file.txt
      # interactive shell with command execution
      netcat.py -t 192.168,1,108 -p 5555 -l -e=\"cat /etc/passwd\"
      # Send string data to target server on port 135
  ...
  parser.add_argument("-f", "--file", help="file upload")
